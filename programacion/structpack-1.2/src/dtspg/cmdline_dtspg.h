...
#ifndef CMDLINE_DTSBG_H
#define CMDLINE_DTSBG_H
...
#define CMDLINE_PARSER_PACKAGE "dtspg"
#endif

#ifndef CMDLINE_PARSER_PACKAGE_NAME
/** @brief the complete program name (used for help and version) */
#define CMDLINE_PARSER_PACKAGE_NAME "dtspg"
#endif
...
struct gengetopt_args_info_dtspg
{
  ...
  int block_size_arg;	/**< @brief Block size.  */
  ...
  int number_blocks_arg;	/**< @brief Number of blocks.  */
  char * number_blocks_orig;	/**< @brief Number of blocks original value given at command line.  */
  const char *number_blocks_help; /**< @brief Number of blocks help description.  */
  char * toeplitz_file_arg;	/**< @brief File containing toeplitz vector values (set to '-' to use standard input).  */
  char * toeplitz_file_orig;	/**< @brief File containing toeplitz vector values (set to '-' to use standard input) original value given at command line.  */
  const char *toeplitz_file_help; /**< @brief File containing toeplitz vector values (set to '-' to use standard input) help description.  */
  int toeplitz_random_flag;	/**< @brief Use random data of specified size as toeplitz vector (default=on).  */
  const char *toeplitz_random_help; /**< @brief Use random data of specified size as toeplitz vector help description.  */
  char * toeplitz_save_random_arg;	/**< @brief File where random toeplitz data should be saved.  */
  char * toeplitz_save_random_orig;	/**< @brief File where random toeplitz data should be saved original value given at command line.  */
  const char *toeplitz_save_random_help; /**< @brief File where random toeplitz data should be saved help description.  */
  ...
  unsigned int number_blocks_given ;	/**< @brief Whether number-blocks was given.  */
  unsigned int toeplitz_file_given ;	/**< @brief Whether toeplitz-file was given.  */
  unsigned int toeplitz_random_given ;	/**< @brief Whether toeplitz-random was given.  */
  unsigned int toeplitz_save_random_given ;	/**< @brief Whether toeplitz-save-random was given.  */
...
struct cmdline_parser_params
{
  ...
  int initialize; /**< @brief whether to initialize the option structure gengetopt_args_info_dtspg (default 1) */
  int check_required; /**< @brief whether to check that all required options were provided (default 1) */
  int check_ambiguity; /**< @brief whether to check for options already specified in the option structure gengetopt_args_info_dtspg (default 0) */
  int print_errors; /**< @brief whether getopt_long should print an error message for a bad option (default 1) */
} ;

/** @brief the purpose string of the program */
extern const char *gengetopt_args_info_dtspg_purpose;
/** @brief the usage string of the program */
extern const char *gengetopt_args_info_dtspg_usage;
/** @brief all the lines making the help output */
extern const char *gengetopt_args_info_dtspg_help[];
...
int cmdline_parser (int argc, char **argv,
  struct gengetopt_args_info_dtspg *args_info);
...
/**
 * Initializes the passed gengetopt_args_info_dtspg structure's fields
 * (also set default values for options that have a default)
 * @param args_info the structure to initialize
 */
void cmdline_parser_init (struct gengetopt_args_info_dtspg *args_info);
/**
 * Deallocates the string fields of the gengetopt_args_info_dtspg structure
 * (but does not deallocate the structure itself)
 * @param args_info the structure to deallocate
 */
void cmdline_parser_free (struct gengetopt_args_info_dtspg *args_info);
 ...
 * @return
 */
int cmdline_parser_required (struct gengetopt_args_info_dtspg *args_info,
