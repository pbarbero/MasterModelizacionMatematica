...
#ifndef CMDLINE_DTS_H
#define CMDLINE_DTS_H
...
#define CMDLINE_PARSER_PACKAGE "dts"
#endif

#ifndef CMDLINE_PARSER_PACKAGE_NAME
/** @brief the complete program name (used for help and version) */
#define CMDLINE_PARSER_PACKAGE_NAME "dts"
#endif
...
struct gengetopt_args_info_dts
{
  ...
  int pivoting_flag;	/**< @brief Uses diagonal pivoting (default=off).  */
  const char *pivoting_help; /**< @brief Uses diagonal pivoting help description.  */
  int core_affinity_flag;	/**< @brief Uses thread/core affinity (probably improves performance) (default=off).  */
  const char *core_affinity_help; /**< @brief Uses thread/core affinity (probably improves performance) help description.  */
  ...
  unsigned int core_affinity_given ;	/**< @brief Whether core-affinity was given.  */
...
struct cmdline_parser_params
{
  ...
  int initialize; /**< @brief whether to initialize the option structure gengetopt_args_info_dts (default 1) */
  int check_required; /**< @brief whether to check that all required options were provided (default 1) */
  int check_ambiguity; /**< @brief whether to check for options already specified in the option structure gengetopt_args_info_dts (default 0) */
  int print_errors; /**< @brief whether getopt_long should print an error message for a bad option (default 1) */
} ;

/** @brief the purpose string of the program */
extern const char *gengetopt_args_info_dts_purpose;
/** @brief the usage string of the program */
extern const char *gengetopt_args_info_dts_usage;
/** @brief all the lines making the help output */
extern const char *gengetopt_args_info_dts_help[];
...
int cmdline_parser (int argc, char * const *argv,
  struct gengetopt_args_info_dts *args_info);
...
/**
 * Initializes the passed gengetopt_args_info_dts structure's fields
 * (also set default values for options that have a default)
 * @param args_info the structure to initialize
 */
void cmdline_parser_init (struct gengetopt_args_info_dts *args_info);
/**
 * Deallocates the string fields of the gengetopt_args_info_dts structure
 * (but does not deallocate the structure itself)
 * @param args_info the structure to deallocate
 */
void cmdline_parser_free (struct gengetopt_args_info_dts *args_info);
 ...
 * @return
 */
int cmdline_parser_required (struct gengetopt_args_info_dts *args_info,
